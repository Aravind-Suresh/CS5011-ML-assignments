...
class Network(object):
    ...
    def backprop(self, x, y):
        ...
        for b, w in zip(self.biases, self.weights):
            ...
            # print 226, w.shape, b.shape, z.shape, activation.shape
            # print z
            # sys.exit()
            activations.append(activation)
        # backward pass
        delta = (self.cost).delta(zs[-1], activations[-1], y)
        print delta.shape, activations[-1].shape
        nabla_b[-1] = delta
...
net = Network(config)
data = zip(train_X, train_Y_labels)
net.SGD(data, 100, 10, 1)
